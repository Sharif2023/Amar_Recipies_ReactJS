                ...
                <ul className="space-y-6">
                    <li>
                        <button
                            ...
                            className="w-full text-left py-2 px-4 rounded-md hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-600 flex items-center space-x-3 hover:text-red-400"
                        >
